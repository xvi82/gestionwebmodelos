...
<p>Frente a dicha pretensión se opone la parte demandada, manifestando que las nóminas han sido abonadas oportunamente, sin que exista ninguna deuda salarial con la persona trabajadora.</p>
<p></p>
...
<p></p>
<p><strong>CUARTO.-</strong> En el supuesto enjuiciado, <span class="word" title="id: caso">${caso}<span>.</p>
<p>Por ello, habiéndose acreditado por la empresa el abono correcto de las retribuciones de la persona trabajadora, cumpliendo con lo dispuesto en los arts. 4.2 f), 26, 29, 31 y concordantes del ET, debe desestimarse la demanda.</p>
...
<p>Desestimo la demanda de reclamación de cantidad interpuesta por <span class="word" title="id: actor">${actor}</span> frente a la empresa <span class="word" title="id: demandado">${demandado}</span>, absolviendo a esta de las pretensiones contra ella deducidas en el presente proceso.</p>
